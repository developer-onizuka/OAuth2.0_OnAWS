...
The AWS STS (Temporary security credentials in IAM) is used as an interface between Hashi-Corp and IAM. See also #3 below: <br>
...
| --- | --- | --- |
| **from on-premises** <br> (within the organization)| Connection String | - Connection String <br> - Temporary security credentials in IAM (with Hashi Corp Vault and Intel SGX)|
